    ...
    public partial class frmProducto : Form
    {
        ...
        private void btnguardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (resultado)
                {
                    ...
                    row.Cells["Categoria"].Value = ((OpcionCombo)cbocategoria.SelectedItem).Valor.ToString();
        ...
        private void dgvdata_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dgvdata.Columns[e.ColumnIndex].Name == "btnseleccionar")
            {
                ...
                if (indice >= 0)
                {
                    ...
                    {
                        if (Convert.ToInt32(oc.Valor) == Convert.ToInt32(dgvdata.Rows[indice].Cells["IdCategoia"].Value))
                        {
        ...
        private void btnbuscar_Click(object sender, EventArgs e)
        {
            ...
            if (dgvdata.Rows.Count > 0)
            {
                ...
                {
                    if (row.Cells[columnaFiltro].Value.ToString().Trim().ToUpper().Contains(txtbusqueda.Text.Trim()))
                    {
                        row.Visible = true;
                    }
                    else
